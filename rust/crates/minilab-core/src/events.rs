...
//!
//! **Normative:** [ADR 0005](../../../../docs/adr/0005-typed-evidence-event-streams.md) (M0 = table/schema constants only; **`event_type` vocab = M1**) · [M0 event map](../../../../docs/milestones/M0-event-map.md) · **Crosswalk:** [M0-crosswalk.md](../../../../docs/milestones/M0-crosswalk.md) · [domain §8](../../../../docs/minilab-persistence-domain-model.md)
